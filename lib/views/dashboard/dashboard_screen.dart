      ...
      child: Scaffold(
        ...
        body: Obx(() {
          ...
          final visibleClubs = isChairperson
              ? controller.clubs
                  .where((c) => c.id == authController.myClubId)
                  .toList()
              : controller.clubs.toList();

          final clubItems = visibleClubs.isEmpty
              ? [
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color: _domainColor(club.domain),
                                ),
                              ),
